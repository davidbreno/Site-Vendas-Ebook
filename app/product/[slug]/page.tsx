  ...
  return (
    <main className="min-h-screen bg-navy">
      ...
      <section className="relative py-24 lg:py-32 bg-navy-light overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-navy/80 via-navy/95 to-navy-light opacity-90" />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-[1.7fr_1fr] items-start">
            <div className="space-y-8">
              <div className="inline-flex items-center gap-3 rounded-full border border-gold/20 bg-navy/80 px-4 py-2 text-sm text-cream/80">
              ...
              <div className="space-y-6">
                ...
                <p className="text-cream/70 text-lg sm:text-xl leading-relaxed max-w-3xl">
                  {product.description}
                </p>
              </div>
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                <div className="rounded-[2rem] border border-gold/25 bg-navy/70 p-8">
                  ...
                  <div className="mt-4 flex items-center gap-4">
                    ...
                    <span className="text-cream/40 line-through">{product.originalPrice}</span>
                  </div>
                </div>
              ...
              <div className="rounded-[2rem] border border-gold/25 bg-navy/70 p-8">
                <div className="flex items-center justify-between gap-4 mb-6">
                  <div>
                    ...
                    <h2 className="text-2xl font-semibold text-cream mt-3">Benefícios que fazem a diferença</h2>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  {benefits.map((benefit) => (
                    <div key={benefit} className="flex items-start gap-3">
                      ...
                      <p className="text-cream/70 text-sm leading-relaxed">{benefit}</p>
                    </div>
                  ))}
                </div>
              </div>
